...
NODEJS(){
  ...
  sed -i -e 's/MONGO_DNSNAME/mongodb.devops.internal/' -e 's/REDIS_ENDPOINT/redis.devops.internal/' -e 's/MONGO_ENDPOINT/mongodb.devops.internal/' /home/roboshop/${COMPONENT}/systemd.service &>>${LOG_FILE} && mv /home/roboshop/${COMPONENT}/systemd.service /etc/systemd/system/${COMPONENT}.service &>>${LOG_FILE}
